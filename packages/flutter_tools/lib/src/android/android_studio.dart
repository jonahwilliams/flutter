...
class AndroidStudio implements Comparable<AndroidStudio> {
  ...
  static AndroidStudio? fromMacOSBundle(String bundlePath) {
    ...
    return AndroidStudio(studioPath,
        version: version, presetPluginsPath: presetPluginsPath);
  }
  ...
  static List<AndroidStudio> _allMacOS() {
    ...
    return candidatePaths
        .map<AndroidStudio?>(
            (FileSystemEntity e) => AndroidStudio.fromMacOSBundle(e.path))
  ...
  static List<AndroidStudio> _allLinuxOrWindows() {
    ...
    if (homeDirPath != null && globals.fs.directory(homeDirPath).existsSync()) {
      ...
      for (final Directory entity in entities) {
        ...
        if (studio != null &&
            !hasStudioAt(studio.directory, newerThan: studio.version)) {
          studios.removeWhere(
            ...
            if (installPath != null &&
              ...
              if (!hasStudioAt(studio.directory, newerThan: studio.version)) {
                studios.removeWhere((AndroidStudio other) =>
                    other.directory == studio.directory);
                studios.add(studio);
              }
            }
          }
    ...
    if (configuredStudioDir != null && !hasStudioAt(configuredStudioDir)) {
      studios.add(
          AndroidStudio(configuredStudioDir, configured: configuredStudioDir));
    }
