...
class UnpackWindows extends Target {
  ...
  Future<void> build(Environment environment) async {
    ...
    final String basePath = environment.artifacts.getArtifactPath(Artifact.windowsDesktopPath);
    for (final File input in environment.fileSystem.directory(basePath)
      ...
      environment.fileSystem.file(input).copySync(destinationFile.path);
    }
  }
}
