  ...
  Future<FlutterCommandResult> runCommand() async {
    ...
    if (_fileSystem.file('l10n.yaml').existsSync()) {
      ...
      final String inputPathString =
          stringArgDeprecated('arb-dir')!; // Has default value, cannot be null.
      final String? outputPathString = stringArgDeprecated('output-dir');
      final String outputFileString = stringArgDeprecated(
          'output-localization-file')!; // Has default value, cannot be null.
      final String templateArbFileName = stringArgDeprecated(
          'template-arb-file')!; // Has default value, cannot be null.
      final String? untranslatedMessagesFilePath =
          stringArgDeprecated('untranslated-messages-file');
      final String classNameString = stringArgDeprecated(
          'output-class')!; // Has default value, cannot be null.
      final List<String> preferredSupportedLocales =
          stringsArg('preferred-supported-locales');
      ...
      final String? inputsAndOutputsListPath =
          stringArgDeprecated('gen-inputs-and-outputs-list');
      ...
      final bool areResourceAttributesRequired =
          boolArgDeprecated('required-resource-attributes');
