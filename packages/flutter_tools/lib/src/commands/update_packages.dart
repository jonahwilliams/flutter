...
const Map<String, String> _kManuallyPinnedDependencies = <String, String>{
  ...
  'boolean_selector': '2.1.0-nullsafety.2',
  'characters': '1.1.0-nullsafety.4',
  'charcode': '1.2.0-nullsafety.2',
  'clock': '1.1.0-nullsafety.2',
  'collection': '1.15.0-nullsafety.4',
  'fake_async': '1.2.0-nullsafety.2',
  'js': '0.6.3-nullsafety.2',
  'matcher': '0.12.10-nullsafety.2',
  'meta': '1.3.0-nullsafety.5',
  'path': '1.8.0-nullsafety.2',
  'pedantic': '1.10.0-nullsafety.2',
  'pool': '1.5.0-nullsafety.2',
  'source_maps': '0.10.10-nullsafety.2',
  'source_map_stack_trace': '2.1.0-nullsafety.3',
  'source_span': '1.8.0-nullsafety.3',
  'stack_trace': '1.10.0-nullsafety.5',
  'stream_channel': '2.1.0-nullsafety.2',
  'string_scanner': '1.1.0-nullsafety.2',
  ...
  'process': '4.0.0-nullsafety.3',
  'process_runner': '4.0.0-nullsafety.4',
