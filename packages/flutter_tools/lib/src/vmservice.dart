...
Future<vm_service.VmService> setUpVmService(
    ...
    PrintStructuredErrorLogMethod? printStructuredErrorLogMethod,
    vm_service.VmService vmService) async {
  ...
  if (reloadSources != null) {
    vmService.registerServiceCallback('reloadSources',
    ...
    registrationRequests
        .add(vmService.registerService('reloadSources', 'Flutter Tools'));
  }

  if (restart != null) {
    vmService.registerServiceCallback('hotRestart',
        (Map<String, Object?> params) async {
      final bool pause =
    ...
    registrationRequests
        .add(vmService.registerService('hotRestart', 'Flutter Tools'));
  }

  vmService.registerServiceCallback('flutterVersion',
      (Map<String, Object?> params) async {
    final FlutterVersion version =
        context.get<FlutterVersion>() ?? FlutterVersion();
  ...
  registrationRequests
      .add(vmService.registerService('flutterVersion', 'Flutter Tools'));
  ...
  if (compileExpression != null) {
    ...
    registrationRequests
        .add(vmService.registerService('compileExpression', 'Flutter Tools'));
  }
  if (device != null) {
    vmService.registerServiceCallback('flutterMemoryInfo',
        (Map<String, Object?> params) async {
    ...
    registrationRequests
        .add(vmService.registerService('flutterMemoryInfo', 'Flutter Tools'));
  }
  if (skSLMethod != null) {
    vmService.registerServiceCallback('flutterGetSkSL',
        (Map<String, Object?> params) async {
    ...
    registrationRequests
        .add(vmService.registerService('flutterGetSkSL', 'Flutter Tools'));
  }
  if (printStructuredErrorLogMethod != null) {
    ...
    registrationRequests.add(vmService
        ...
        .catchError((Object? error) => null,
            test: (Object? error) => error is vm_service.RPCError));
  }
