...
void main() {
  ...
  group('pluginsPath on Mac', () {
    ...
    testUsingContext('Can discover Android Studio >=4.1 location on Mac', () {
      ...
      final String plistFilePath =
          globals.fs.path.join(studioInApplicationPlistFolder, 'Info.plist');
      plistUtils.fileContents[plistFilePath] = macStudioInfoPlist4_1;
      processManager.addCommand(FakeCommand(
        command: <String>[
          globals.fs.path.join(studioInApplicationPlistFolder, 'jre', 'jdk',
    ...
    testUsingContext('Can discover Android Studio >=2020.3 location on Mac',
      ...
      processManager.addCommand(FakeCommand(
        command: <String>[
          globals.fs.path.join(studioInApplicationPlistFolder, 'jre',
              'Contents', 'Home', 'bin', 'java'),
          '-version',
        ],
        stderr: '123',
    ...
    testUsingContext(
      ...
      final String applicationsPlistFilePath =
          globals.fs.path.join(applicationPlistFolder, 'Info.plist');
      ...
      final String homeDirectoryPlistFilePath =
          globals.fs.path.join(homeDirectoryPlistFolder, 'Info.plist');
    ...
    testUsingContext(
      ...
      processManager.addCommand(FakeCommand(
        command: <String>[
          globals.fs.path.join(studioInApplicationPlistFolder, 'jbr',
              'Contents', 'Home', 'bin', 'java'),
          '-version',
        ],
        stderr: '123',
  ...
  testUsingContext(
      'Does not discover Android Studio 4.2 location on Windows if LOCALAPPDATA is null',
      () {
    windowsFileSystem
        .file(r'C:\Users\Dash\AppData\Local\Google\AndroidStudio4.2\.home')
      ..createSync(recursive: true)
  ...
  testUsingContext(
      'Does not discover Android Studio 2020.3 location on Windows if LOCALAPPDATA is null',
      () {
    windowsFileSystem
        .file(r'C:\Users\Dash\AppData\Local\Google\AndroidStudio2020.3\.home')
      ..createSync(recursive: true)
