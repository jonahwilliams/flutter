...
void main() {
  ...
  testbed.test('Copies files to correct cache directory, excluding unrelated code',  () async {
  ...
  testbed.test('Does not re-copy files unecessarily',  () async {
  ...
  testbed.test('Detects changes in input cache files',  () async {
    await buildSystem.build(const UnpackLinuxDebug(), environment);
  ...
  testbed.test('Copies artifacts to out directory',  () async {
