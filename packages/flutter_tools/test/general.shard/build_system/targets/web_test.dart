...
void main() {
  ...
  test(
      ...
      () => testbed.run(() async {
            ...
            await const WebReleaseBundle(WebRendererMode.autoDetect, false)
                .build(environment);
...
''');
  ...
  test(
      ...
      () => testbed.run(() async {
            ...
            await WebServiceWorker(globals.fs, globals.cache,
                    WebRendererMode.autoDetect, false)
                .build(environment);
  ...
  test(
      ...
      () => testbed.run(() async {
            ...
            await WebBuiltInAssets(globals.fs, globals.cache, false)
                .build(environment);
  ...
  test(
      ...
      () => testbed.run(() async {
            ...
            await WebBuiltInAssets(globals.fs, globals.cache, true)
                .build(environment);
