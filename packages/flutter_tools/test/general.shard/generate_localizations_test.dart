...
void main() {
  ...
  testWithoutContext(
    ...
    l10nDirectory
        ...
        .writeAsStringSync(singleMessageArbFileString);
    l10nDirectory
        .childFile('app_localizations_es.arb')
        .writeAsStringSync(singleEsMessageArbFileString);
    LocalizationsGenerator(
      fileSystem: fs,
      inputPathString: defaultL10nPathString,
  ...
  testWithoutContext('filenames with invalid locales should not be recognized',
    ...
    l10nDirectory
        ...
        .writeAsStringSync(singleMessageArbFileString);
    l10nDirectory
        .childFile('app_localizations_en_CA_foo.arb')
        .writeAsStringSync(singleMessageArbFileString);
    expect(
      () {
        LocalizationsGenerator(
  ...
  testWithoutContext(
    ...
    fs.currentDirectory.childDirectory('lib').childDirectory('l10n')
      ..createSync(recursive: true)
      ..childFile(defaultTemplateArbFileName)
          .writeAsStringSync(twoMessageArbFileString)
      ..childFile(esArbFileName)
          .writeAsStringSync(singleEsMessageArbFileString);
    ...
    LocalizationsGenerator(
      ...
      outputFileString: defaultOutputFileString,
      classNameString: defaultClassNameString,
      untranslatedMessagesFile: fs.path
          .join('lib', 'l10n', 'unimplemented_message_translations.json'),
      logger: logger,
    )
      ..loadResources()
      ..writeOutputFiles();
    ...
    final String unimplementedOutputString =
        unimplementedOutputFile.readAsStringSync();
    try {
      ...
      l10nDirectory.childFile(defaultTemplateArbFileName).writeAsStringSync(r'''
{
  "helloWorld": "Hello world!"
      ...
      LocalizationsGenerator(
        ...
        ..loadResources()
        ..writeOutputFiles();
      final File baseLocalizationsFile = fs.file(fs.path
          .join(syntheticL10nPackagePath, 'output-localization-file.dart'));
      expect(baseLocalizationsFile.existsSync(), isTrue);

      final String baseLocalizationsFileContents = fs
          .file(fs.path
              .join(syntheticL10nPackagePath, 'output-localization-file.dart'))
          .readAsStringSync();
      expect(baseLocalizationsFileContents,
  ...
  /// Use this for tests!'''));
    ...
    testWithoutContext(
      ...
      final String baseLocalizationsFileContents = fs
          ...
          .readAsStringSync();
      expect(baseLocalizationsFileContents,
          contains('/// Title for the application.'));
      expect(baseLocalizationsFileContents, contains('''
      ...
      l10nDirectory.childFile(esArbFileName).writeAsStringSync(r'''
{
  "price": "el precio de este artículo es: ${price}"
      ...
      final String baseLocalizationsFileContents = fs
          ...
          .readAsStringSync();
      expect(baseLocalizationsFileContents,
          contains('/// The price of an online shopping cart item.'));
      expect(baseLocalizationsFileContents, contains(r'''
  /// In en, this message translates to:
      ...
      const String singleEnCaMessageArbFileString = '''
{
  "title": "Canadian Title"
      ...
      fs.currentDirectory.childDirectory('lib').childDirectory('l10n')
        ...
        ..childFile(defaultTemplateArbFileName)
            .writeAsStringSync(singleMessageArbFileString)
        ..childFile('app_en_CA.arb')
            .writeAsStringSync(singleEnCaMessageArbFileString);
      ...
      expect(
          fs.isFileSync(fs.path.join(
              syntheticL10nPackagePath, 'output-localization-file_en_US.dart')),
          false);
      ...
      final String englishLocalizationsFile = fs
          .file(fs.path.join(
              syntheticL10nPackagePath, 'output-localization-file_en.dart'))
          .readAsStringSync();
      expect(englishLocalizationsFile,
    ...
    testWithoutContext(
      ...
      final String localizationsFile = fs
          .file(
...
'''));
      expect(localizationsFile,
          contains('output-localization-file_en.loadLibrary()'));
    });
        ...
        const String pluralMessageWithIncorrectPlaceholderFormat = '''
{
  ...
  "@helloWorlds": {
    ...
    group('select messages', () {
      testWithoutContext(
          'should auotmatically infer select placeholders that are not explicitly defined',
          () {
...
''';
      ...
      fs.currentDirectory.childDirectory('lib').childDirectory('l10n')
        ..createSync(recursive: true)
        ..childFile(defaultTemplateArbFileName)
            .writeAsStringSync(pluralMessageArb)
...
''';
      ...
      fs.currentDirectory.childDirectory('lib').childDirectory('l10n')
        ..createSync(recursive: true)
        ..childFile(defaultTemplateArbFileName)
            .writeAsStringSync(selectMessageArb)
...
''';
      ...
      fs.currentDirectory.childDirectory('lib').childDirectory('l10n')
        ..createSync(recursive: true)
        ..childFile(defaultTemplateArbFileName)
            .writeAsStringSync(enArbCheckList)
